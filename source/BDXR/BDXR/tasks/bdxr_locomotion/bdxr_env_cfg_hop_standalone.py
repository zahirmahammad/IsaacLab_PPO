...
"""BDXR Bunny Hopping Environment Configuration - Standalone"""
...
@configclass
class CommandsCfg:
    """Command specifications for bunny hopping."""
    base_velocity = mdp.UniformVelocityCommandCfg(
        ...
        ranges=mdp.UniformVelocityCommandCfg.Ranges(
            lin_vel_x=(0.3, 2.5), lin_vel_y=(0.0, 0.0), ang_vel_z=(0.0, 0.0), heading=(-math.pi, math.pi)
        ),
    )
...
@configclass
class ActionsCfg:
    """Action specifications for hopping."""
    joint_pos = mdp.JointPositionActionCfg(asset_name="robot", joint_names=[".*"], scale=0.5, use_default_offset=True)


@configclass
class ObservationsCfg:
    """Observation specifications for hopping."""
    @configclass
...
@configclass
class HopRewards(RewardsCfg):
    """Reward terms for bunny hopping."""

    termination_penalty = RewTerm(func=mdp.is_terminated, weight=-200.0)
    
    # HOPPING REWARDS - maximize air time and forward velocity with synchronized legs
    air_time = RewTerm(
...
@configclass
class BdxrEnvCfg_Hop(LocomotionVelocityRoughEnvCfg):
    """BDXR Bunny Hopping Environment - Standalone Configuration."""

    commands: CommandsCfg = CommandsCfg()
    rewards: HopRewards = HopRewards()
    ...
    def __post_init__(self):
        ...
        # Disable parent class reward terms that don't work with our body names
        ...
        # Reward setup for bunny hopping
...
@configclass
class BdxrEnvCfg_Hop_PLAY(BdxrEnvCfg_Hop):
    """BDXR Bunny Hopping Environment for Play/Evaluation."""
